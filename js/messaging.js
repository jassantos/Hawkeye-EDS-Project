...
window.Messaging = (function(){
  ...
  const demoContacts = [
    { id: 1, name: "Jane Doe", last: "Hi, i want make enquiries about yo...", color:"#fda4af", badge:"New" },
    { id: 2, name: "Janet Adebayo", last: "Hi, i want make enquiries about yo...", color:"#93c5fd" },
    { id: 3, name: "Kunle Adekunle", last: "Macbook Pro", color:"#86efac" },
  ];
  const demoThreads = {
    1: [
      { sep: "31 March 2025" },
